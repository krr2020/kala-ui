...
- `EXAMPLES.md` — usage doc per hook; update it when changing a hook's API.
...
- New hook = `src/<name>/` directory + test in `src/__tests__/` + barrel entry in `src/index.ts` + `EXAMPLES.md` section.
