export const selectTriggerStyles = {
	...
	variants: {
		size: {
			md: "h-[var(--kala-control-h)] px-3 py-2 text-sm",
...
export const selectItemStyles = {
	base: "cursor-pointer focus:bg-accent focus:text-accent-foreground relative flex w-full cursor-default items-center gap-2 rounded-[var(--kala-radius-sm)] py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
};
