...
export const dialogStyles = {
	...
	close: "absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none p-1 hover:bg-accent",
	closeIcon: "size-5",
	header: "flex flex-col gap-1.5 px-6 py-4 border-b",
	footer: "flex flex-col-reverse gap-2 sm:flex-row sm:justify-end px-6 py-4 border-t bg-muted/50 rounded-b-lg",
