export const alertStyles = {
  ...
  variants: {
    ...
    style: {
      ...
      solid: 'border-transparent text-primary-foreground [&>svg]:text-primary-foreground',
    },
  },
  compoundVariants: [
    // Default style variants
    {
      variant: 'primary',
      style: 'default',
      className: 'bg-primary/10 border-primary/20 text-primary [&>svg]:text-primary',
    },
    {
      variant: 'secondary',
      style: 'default',
      className: 'bg-muted border text-foreground [&>svg]:text-muted-foreground',
    },
    {
      variant: 'success',
      style: 'default',
      className: 'bg-success/10 border-success/20 text-success [&>svg]:text-success',
    },
    {
      variant: 'danger',
      style: 'default',
    ...
    },
    {
      variant: 'warning',
      style: 'default',
      className: 'bg-warning/10 border-warning/20 text-warning [&>svg]:text-warning',
    },
    {
      variant: 'info',
      style: 'default',
    ...
    },
    {
      variant: 'secondary',
      style: 'outline',
      className: 'border-muted-foreground text-muted-foreground [&>svg]:text-muted-foreground',
    },
    {
      variant: 'success',
      style: 'outline',
