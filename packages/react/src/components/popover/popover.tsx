...
const PopoverVariantContext = React.createContext<PopoverContentProps['variant']>('default');
    ...
    <PopoverVariantContext.Provider value={variant}>
      <PopoverPrimitive.Portal>
        <PopoverPrimitive.Content
          ...
          className={cn('group', popoverVariants({ variant, padding }), className)}
          {...props}
        >
          {children}
          {showArrow && (
...
function PopoverHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  ...
  return <div className={cn(popoverHeaderVariants({ variant }), className)} {...props} />;
}
