...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    return <div ref={ref} className={cn(cardStyles.base, className)} {...props} />;
  },
);
...
function CardImage({ className, alt = '', ...props }: React.ImgHTMLAttributes<HTMLImageElement>) {
  ...
  return <img alt={alt} className={cn(cardStyles.image, className)} {...props} />;
}

function CardImageOverlay({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
