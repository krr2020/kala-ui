...
const Steps = React.forwardRef<HTMLDivElement, StepsProps>(
  ({ className, orientation, currentStep, items, onStepClick, showLine = true, ...props }, ref) => {
    return (
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  {isCompleted ? <Check className="h-4 w-4" /> : step.icon || stepNumber}
                </button>

                {/* Content */}
                <div className={cn(orientation === 'vertical' ? 'ml-4' : 'mt-2 text-center px-2')}>
                  <div
                    className={cn(
                      'text-sm font-medium',
