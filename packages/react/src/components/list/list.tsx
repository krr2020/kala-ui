...
function List({ className, divided = true, dense = false, ...props }: ListProps) {
  return (
    <ul
      className={cn(
...
function ListItemIcon({ className, size = 'default', children, ...props }: ListItemIconProps) {
  return (
    <div
      className={cn(
...
function ListItemContent({ className, truncate = false, ...props }: ListItemContentProps) {
  return (
    <div className={cn('flex-1 min-w-0', truncate && 'overflow-hidden', className)} {...props} />
  );
}
...
export interface ListItemTitleProps extends React.HTMLAttributes<HTMLHeadingElement> {
  /**
   * Truncate text with ellipsis
   * @default false
   */
...
function ListItemTitle({
  ...
  return (
    <Component
      className={cn('text-sm font-medium text-foreground', truncate && 'truncate', className)}
      {...props}
    />
  );
}
...
export interface ListItemTextProps extends React.HTMLAttributes<HTMLParagraphElement> {
  /**
   * Truncate text with ellipsis
   * @default false
   */
...
function ListItemText({ className, truncate = false, lines, ...props }: ListItemTextProps) {
  return (
    <p
      className={cn(
...
function ListItemAction({ className, ...props }: ListItemActionProps) {
  return <div className={cn('shrink-0 flex items-center gap-2', className)} {...props} />;
}
...
export interface ListItemBadgeProps extends React.HTMLAttributes<HTMLSpanElement> {
  /**
   * Badge variant
   * @default 'default'
   */
...
function ListItemBadge({ className, variant = 'default', ...props }: ListItemBadgeProps) {
