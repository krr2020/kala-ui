...
describe("AreaChart", () => {
	...
	it("should handle reference lines", async () => {
		render(
			<AreaChart
				{...defaultProps}
	...
	it("should handle reference lines with custom color and dash array", async () => {
		render(
			<AreaChart
				{...defaultProps}
				referenceLines={[
	...
	it("should set stacked mode in options", async () => {
	...
	it("should enable data labels when prop is true", async () => {
