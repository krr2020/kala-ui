...
export function SessionCard({ session, onRevoke, isRevoking, className }: SessionCardProps) {
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3 flex-1">
            <DeviceIcon className="size-6 text-muted-foreground mt-0.5" aria-hidden="true" />
