    ...
    return (
      ...
      >
        <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          {centered && children && (
            <div className="mb-12 flex flex-col items-center text-center">{children}</div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            {!centered && children && <div className="md:col-span-2 lg:col-span-1">{children}</div>}
          </div>
          ...
          >
            {/* Copyright */}
            <div className="text-sm text-muted-foreground order-2 md:order-1">{copyrightText}</div>
